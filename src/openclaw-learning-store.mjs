...
export function normalizeLearningProfile(profile) {
  ...
  return {
    ...
    eligibleArticleCount: clampInteger(normalized.eligibleArticleCount, 0, 1_000_000, 0),
    excludedArticleCount: clampInteger(normalized.excludedArticleCount, 0, 1_000_000, 0),
